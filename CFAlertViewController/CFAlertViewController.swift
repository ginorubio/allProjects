                ...
                if self.preferredStyle == .notification {
                    ...
                    if #available(iOS 11.0, *) {
                        ...
                        if let tableView = self.tableView   {
                            ...
                            tableView.contentInset = UIEdgeInsets(top: statusbarHeight, left: tableView.contentInset.left, bottom: tableView.contentInset.bottom, right: tableView.contentInset.right)
